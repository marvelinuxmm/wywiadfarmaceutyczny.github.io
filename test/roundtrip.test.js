...
s.ocenaBolu = { data: '2026-08-12', skala: 'nrs', nrsAktualne: '6', nrsSrednie: '5', lekiNaBol: [1, 2], lokalizacja: { glowa: true }, halt: { q1: '3', q2: '2' }, epikryza: 'x' };
...
assert.strictEqual(merged.palenie, 'tak');
...
assert.strictEqual(merged.ocenaBolu.halt.q1, '3');
assert.strictEqual(merged.ocenaBolu.halt.q2, '2');
assert.strictEqual(merged.ocenaBolu.halt.q5, '', 'niepodane pytania HALT pozostają puste');
